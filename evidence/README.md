...
No reviewed complete-reserves distribution, provisioning calibration,
three-cell execution, 120-run matrix, or counted capacity evidence is published
here. Ignored runtime output is not evidence merely because it exists.
